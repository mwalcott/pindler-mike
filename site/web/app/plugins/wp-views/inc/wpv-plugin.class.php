	...
	*/
	...
	function wpv_register_assets() {
		...
		*/
		...
		wp_register_script( 'views-layout-wizard-script' , WPV_URL . '/res/js/redesign/views_layout_edit_wizard.js', array('jquery', 'views-layout-template-js', 'views-shortcodes-gui-script', 'toolset-colorbox'), WPV_VERSION, true);
