    ...
    <li id="wpv-ct-listing-<?php echo esc_attr( $ct_id ); ?>" class="js-wpv-ct-listing js-wpv-ct-listing-show js-wpv-ct-listing-<?php echo esc_attr( $ct_id ); ?> layout-html-editor" data-id="<?php echo esc_attr( $ct_id ); ?>" data-viewid="<?php echo esc_attr( $view_id ); ?>" data-attributes="<?php echo esc_js( json_encode( $extra_ct_attributes ) ); ?>">
		...
		<script type="text/javascript">
			jQuery( document ).ready(function($) {
				if ( typeof WPV_Toolset.CodeMirror_instance["wpv_ct_inline_editor_<?php echo esc_js( $ct_id ); ?>"] === "undefined" ) {
					...
					WPV_Toolset.CodeMirror_instance['wpv_ct_inline_editor_<?php echo esc_js( $ct_id ); ?>'] = icl_editor.codemirror('wpv-ct-inline-editor-<?php echo esc_js( $ct_id ); ?>', true);
					WPV_Toolset.CodeMirror_instance_value['wpv_ct_inline_editor_<?php echo esc_js( $ct_id ); ?>'] = WPV_Toolset.CodeMirror_instance['wpv_ct_inline_editor_<?php echo esc_js( $ct_id ); ?>'].getValue();
					...
					WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_css_editor_' + <?php echo esc_js( $ct_id ); ?>] = icl_editor.codemirror( 'wpv-ct-assets-inline-css-editor-' + <?php echo esc_js( $ct_id ); ?>, true, 'css' );
					WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_css_editor_' + <?php echo esc_js( $ct_id ); ?>].setSize( "100%", 250 );
					WPV_Toolset.CodeMirror_instance_value['wpv_ct_assets_inline_css_editor_<?php echo esc_js( $ct_id ); ?>'] = WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_css_editor_<?php echo esc_js( $ct_id ); ?>'].getValue();
					
					WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_js_editor_' + <?php echo esc_js( $ct_id ); ?>] = icl_editor.codemirror( 'wpv-ct-assets-inline-js-editor-' + <?php echo esc_js( $ct_id ); ?>, true, 'javascript' );
					WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_js_editor_' + <?php echo esc_js( $ct_id ); ?>].setSize( "100%", 250 );
					WPV_Toolset.CodeMirror_instance_value['wpv_ct_assets_inline_js_editor_<?php echo esc_js( $ct_id ); ?>'] = WPV_Toolset.CodeMirror_instance['wpv_ct_assets_inline_js_editor_<?php echo esc_js( $ct_id ); ?>'].getValue();
					
					WPV_Toolset.CodeMirror_instance["wpv_ct_inline_editor_<?php echo esc_js( $ct_id ); ?>"].on('change', function() {
						WPViews.view_edit_screen_inline_content_templates.track_inline_content_template_changes( '<?php echo esc_js( $ct_id ); ?>' );
					});
					WPV_Toolset.CodeMirror_instance["wpv_ct_assets_inline_css_editor_<?php echo esc_js( $ct_id ); ?>"].on('change', function() {
						WPViews.view_edit_screen_inline_content_templates.track_inline_content_template_changes( '<?php echo esc_js( $ct_id ); ?>' );
					});
...
function wpv_ct_update_inline_callback() {
	...
	wpv_register_wpml_strings( $my_post['post_content'] );
