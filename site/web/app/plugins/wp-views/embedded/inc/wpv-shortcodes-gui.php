...
function wpv_force_shortcodes_gui_basic_items( $menu = array() ) {
	...
	if ( isset( $menu[$basic] ) ) {
		...
		$menu[$basic][$bloginfo_title] = array( 
			...
			'wpv-bloginfo',
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-bloginfo', '" . esc_js( $bloginfo_title ) . "', {}, '" . $nonce . "', this )"
		);
		...
		$menu[$basic][$current_user_title] = array( 
			...
			'wpv-current-user',
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-current-user', '" . esc_js( $current_user_title ) . "', {}, '" . $nonce . "', this )"
		);
		// Add wpv-search-term
		...
		$menu[$basic][$search_term_title] = array( 
			...
			'wpv-search-term',
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-search-term', '" . esc_js( $search_term_title ) . "', {}, '" . $nonce . "', this )"
		);
		// Add wpv-login-form
		...
		$menu[$basic][$login_form_title] = array(
			...
			'wpv-login-form',
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-login-form', '" . esc_js( $login_form_title ) . "', {}, '" . $nonce . "', this )"
		);
		// Add wpv-logout-link
		...
		$menu[$basic][$logout_link_title] = array(
				...
				'wpv-logout-link',
				$basic,
				"WPViews.shortcodes_gui.wpv_insert_popup('wpv-logout-link', '" . esc_js( $logout_link_title ) . "', {}, '" . $nonce . "', this )"
		);
		...
		$menu[$basic][$forgot_password_link_title] = array(
			...
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-forgot-password-link', '" . esc_js( $forgot_password_link_title ) . "', {}, '" . $nonce . "', this )"
		);*/
		...
		$menu[$basic][$forgot_password_form_title] = array(
			...
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-forgot-password-form', '" . esc_js( $forgot_password_form_title ) . "', {}, '" . $nonce . "', this )"
		);
		...
		$menu[$basic][$reset_password_form_title] = array(
			...
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-reset-password-form', '" . esc_js( $reset_password_form_title ) . "', {}, '" . $nonce . "', this )"
		);
		...
		$menu[$basic][$archive_link_title] = array(
			...
			'wpv-archive-link',
			$basic,
			"WPViews.shortcodes_gui.wpv_insert_popup('wpv-archive-link', '" . esc_js( $archive_link_title ) . "', {}, '" . $nonce . "', this )"
		);
	}
	return $menu;
}
